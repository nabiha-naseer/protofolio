...
const projectsData: Project[] = [
  {
    ...
    description: "A modern portfolio built using Next.js, TypeScript, Tailwind CSS, Framer Motion, and responsive UI principles.",
  ...
  },
  {
    ...
    description: "A university FAQ system developed to answer frequently asked student questions efficiently.",
  ...
  },
  {
    ...
    description: "A software engineering project designed to manage artists, artworks, exhibitions, and gallery records.",
...
const itemVariants = {
  ...
  show: { 
    opacity: 1, 
    y: 0, 
    transition: { duration: 0.6, ease: "easeOut" as any } // Cast ease to any
  }
};
    ...
    <section className="w-full max-w-5xl mx-auto px-6 py-12">
      ...
      >
        {projectsData.map((project, index) => (
          <motion.div
            key={project.title}
            variants={itemVariants as any} // Cast variants to any
